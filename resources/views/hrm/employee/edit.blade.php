...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" method="POST" action="{{ route('employee.update', $employee->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ old('name') ? old('name') : $employee->name }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('father_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="father_name" type="text" class="form-control" name="father_name" value="{{ old('father_name') ? old('father_name') : $employee->father_name }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('mother_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="mother_name" type="text" class="form-control" name="mother_name" value="{{ old('mother_name') ? old('mother_name') : $employee->mother_name }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" type="tel" class="form-control" name="phone" value="{{ old('phone') ? old('phone') : $employee->phone }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="email" type="email" class="form-control" name="email" value="{{ old('email') ? old('email') : $employee->email }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="birthday" type="date" class="form-control" name="birthday" value="{{ old('birthday') ? old('birthday') : $employee->birthday }}" autofocus>
                           ...
                           <!--  Gender -->
                                ...
                                <div class="col-md-8">
                                    <select id="marital_status" class="form-control" name="marital_status" autofocus>
                                        ...
                                        <option value="divorced"
                                            @if ($employee->marital_status === 'divorced')
                                                selected
                                            @endif
                                            > Divorced
                                        </option>
                                        <option value="widowed"
                                            @if ($employee->marital_status === 'widowed')
                                                selected
                                            @endif
                                            > Widowed
                                        </option>
                            ...
                            <div class="form-group{{ $errors->has('nid') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="nid" type="tel" class="form-control" name="nid" value="{{ old('nid') ? old('nid') : $employee->nid }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('blood_group') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="blood_group" type="text" class="form-control" name="blood_group" value="{{ old('blood_group') ? old('blood_group') : $employee->blood_group }}" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('present_addres') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="present_addres" class="form-control" id="present_addres" cols="30" rows="4" autofocus>{{ old('present_addres') ? old('present_addres') : $employee->present_addres }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('permanent_addres') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <textarea name="permanent_addres" class="form-control" id="permanent_addres" cols="30" rows="4" autofocus>{{ old('permanent_addres') ? old('permanent_addres') : $employee->permanent_addres }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <div class="">
                                         <img src="{{ asset('storage') }}/{{ $employee->avatar }}" alt="avatar"  style="max-width: 100px; height: auto; margin-bottom:10px;">
                                    </div>
                            ...
                            <div class="form-group{{ $errors->has('cv') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="{{ asset('storage') }}/{{ $employee->cv }}" target="_blank" class="btn btn-info btn-sm">View CV</a>
                            ...
                            <div class="form-group{{ $errors->has('signature') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <img src="{{ asset('storage') }}/{{ $employee->signature }}" alt="avatar"  style="max-width: 100px; height: auto; margin-bottom:10px;">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select id="employee_department_id" class="form-control" name="employee_department_id" autofocus>
                                        ...
                                        @forelse ( $employeeDepartment as $department )
                                            <option 
                                                value="{{ $department->id }}" 
                                                {{ $employee->employee_department_id ? 'selected' : '' }} 
                                            >
                                                {{ $department->name }}
                                            </option>
                                        @empty
                                    ...
                                    <select id="employee_designation_id" class="form-control" name="employee_designation_id" autofocus>
                                        ...
                                        @forelse ( $employeeDesignation as $designation )
                                            <option value="{{ $designation->id }}"
                                                {{ $employee->employee_designation_id ? 'selected' : '' }}
                                                >
                                                {{ $designation->name }}
                                            </option>
                                        @empty
                                    ...
                                    <select id="employee_type_id" class="form-control" name="employee_type_id" autofocus>
                                        ...
                                        @forelse ( $employeeType as $type )
                                            <option value="{{ $type->id }}"
                                                {{ $employee->employee_type_id ? 'selected' : '' }}
                                                >
                                                {{ $type->name }}
                                            </option>
                                        @empty
                                    ...
                                    <select id="employee_working_shift_id" class="form-control" name="employee_working_shift_id" autofocus>
                                        ...
                                        @forelse ( $workingShift as $shift )
                                            <option value="{{ $shift->id }}"
                                                {{ $employee->employee_working_shift_id ? 'selected' : '' }}
                                                >
                                                {{ $shift->name }}
                                            </option>
                                        @empty
                                    ...
                                    <select id="employee_pay_scale_id" class="form-control" name="employee_pay_scale_id" autofocus>
                                        ...
                                        @forelse ( $employeePayScale as $scale )
                                            <option value="{{ $scale->id }}"
                                                {{ $employee->employee_pay_scale_id ? 'selected' : '' }}
                                                >
                                                {{ $scale->name }}
                                            </option>
                                        @empty
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('join') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="join" type="date" class="form-control" name="join" value="{{ old('join') ? old('join') : $employee->join }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('education') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="education" class="form-control" id="education" cols="30" rows="3" autofocus>{{ old('education') ? old('education') : $employee->education }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('remark') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="remark" class="form-control" id="remark" cols="30" rows="3" autofocus>{{ old('remark') ? old('remark') : $employee->remark }}</textarea>
