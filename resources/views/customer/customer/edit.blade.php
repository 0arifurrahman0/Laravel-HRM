...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" method="POST" action="{{ route('customer.update',$customer->id) }}">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('accounts_no') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="accounts_no" type="text" class="form-control" name="accounts_no" value="{{ old('accounts_no') ? old('accounts_no') : $customer->accounts_no }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ old('name') ? old('name') : $customer->name }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('father') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="father" type="text" class="form-control" name="father" value="{{ old('father') ? old('father') : $customer->father }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('husband') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="husband" type="text" class="form-control" name="husband" value="{{ old('husband') ? old('husband') : $customer->husband }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" type="tel" class="form-control" name="phone" value="{{ old('phone') ? old('phone') : $customer->phone }}" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('addres') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="addres" class="form-control" id="addres" cols="30" rows="4" autofocus>{{ old('addres') ? old('addres') : $customer->addres }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="description" class="form-control" id="description" cols="30" rows="3" autofocus>{{ old('description') ? old('description') : $customer->description }}</textarea>
